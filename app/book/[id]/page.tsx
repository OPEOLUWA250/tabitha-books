    ...
    <main className="min-h-screen bg-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16">
            ...
            <div className="relative w-full max-w-sm aspect-[3/4] overflow-hidden rounded-2xl shadow-2xl bg-gray-100">
              {displayImage ? (
                <Image
                  ...
                  priority
                  onError={() => {
                    console.error(`❌ Image failed for "${book.title}"`, displayImage);
                  }}
                  onLoad={() => {
                    console.log(`✅ Image loaded for "${book.title}"`);
                  }}
          ...
          <div className="flex flex-col justify-start">
            ...
            <div className="space-y-3 mb-8">
              ...
              {/* WhatsApp Button - Secondary CTA */}
              <a
                href={`https://wa.me/08180018752?text=Hi! I'm interested in "${book.title}" by ${book.author}. Price: ${priceInNaira}. Can you help me order?`}
                target="_blank"
                rel="noopener noreferrer"
                className="w-full py-4 sm:py-5 rounded-xl font-bold text-base sm:text-lg flex items-center justify-center gap-3 border-2 border-green-500 text-green-700 hover:bg-green-50 transition-all duration-300 shadow-md hover:shadow-lg transform hover:scale-105"
              >
      ...
      <Footer />
            ...
            <div className="space-y-3 mb-8">
              ...
              <button
                onClick={handleAddToCart}
                className={`w-full py-3 sm:py-4 rounded-lg font-semibold text-base sm:text-lg flex items-center justify-center gap-2 transition-all duration-300 ${
                  addedToCart
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-full py-3 sm:py-4 rounded-lg font-semibold text-base sm:text-lg border-2 border-green-600 text-green-600 hover:bg-green-50 transition-all duration-300 text-center"
              >
                📱 Order via WhatsApp
              </a>
            </div>
            ...
            <div className="space-y-3 text-sm text-gray-600 font-light">
              <p>✓ Fast, secure checkout via WhatsApp</p>
              <p>✓ Carefully curated for your journey</p>
              <p>✓ From the Tabitha Books collection</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {relatedBooks.length > 0 && (
        <section className="bg-gray-50 py-16 md:py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="font-sans text-3xl sm:text-4xl font-bold text-gray-900 mb-8">
              More from{" "}
